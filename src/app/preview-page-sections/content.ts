...
export const templateDetails = {
  name: `${siteConfig.name} Ecommerce Template`,
  description:
    `Presenting ${siteConfig.name} Template, the ultimate ecommerce template.`,
  screenshotsOne: [
    preview,
    collection,
    singleProduct,
...
export const mainPages = {
  ...
  pages: [
    ...
    },
    {
      ...
      href: "/blog/understanding-product-maintenance-a-historical-perspective",
      CMS: false,
    },
    {
      coverImage: collection,
    ...
    },
    {
      ...
      href: "/products/adjustable-inline-skates",
      CMS: false,
    },
    {
      coverImage: faq,
