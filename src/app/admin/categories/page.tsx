            ...
            {categories.map((category) => (
              ...
              >
                <div className="flex items-center gap-6">
                  <div className="h-24 w-24 rounded-2xl bg-slate-100 flex items-center justify-center overflow-hidden shadow-inner group-hover:bg-indigo-50 transition-colors shrink-0">
                    {category.image_url ? (
                      <img
                      ...
                      <FiPackage className="h-10 w-10 text-slate-300 group-hover:text-indigo-600 transition-colors" />
                    )}
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 group-hover:text-indigo-600 transition-colors">{category.name}</h3>
                    <p className="text-xs font-medium text-slate-400 mt-1 max-w-[300px] line-clamp-2 uppercase tracking-tight">
